const portfolioData = { 
   hero: { 
     ...
     title: "Full-Stack Developer | ECE Undergraduate", 
     description: 
       "I build scalable web applications using React, Node.js, and modern technologies. Passionate about problem-solving, system design, and real-world impactful products.", 
   }, 
   ...
   projects: [ 
     { 
       name: "XTechon Air – Flight Booking System", 
       tech: ["React", "Node.js", "PostgreSQL"], 
       description: [ 
         "Built a full-stack flight booking system with real-time database search", 
         "Implemented JWT authentication and wallet system with transaction tracking", 
         "Developed REST APIs for booking, wallet, and ticket management", 
         "Generated downloadable PDF tickets with unique PNR", 
         "Designed responsive UI with dark/light mode", 
       ], 
       link: "https://flightbooking-e5rr.vercel.app", 
     }, 
     { 
       name: "StudyNotion – EdTech Platform", 
       tech: ["MongoDB", "Express", "React", "Node.js"], 
       description: [ 
         "Developed a full EdTech platform with course management", 
         "Implemented role-based authentication (Student/Instructor)", 
   ...
   achievements: [ 
     "Student Senate Member, IIITDM Jabalpur (2025)", 
   ...
   contact: { 
     email: "anikettheking2004@gmail.com", 
     phone: "+91-6393688279", 
